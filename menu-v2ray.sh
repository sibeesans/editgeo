...
clear
echo -e "${GREEN}=================================================================${NC}"
echo -e "${BLUE}=========================== ${RED}Menu VMESS ${BLUE}==========================${NC}"                    echo -e ""
echo -e "- [01]      : Create V2ray Vmess WS Account" | lolcat
echo -e "- [02]      : Deleting V2ray Vmess WS Account" | lolcat        echo -e "- [03]      : Extending Vmess Account Active Life" | lolcat
echo -e "- [04]      : Check User Login V2ray" | lolcat
echo -e "- [05]      : Renew Certificate V2ray Account" | lolcat                                                         echo -e ""
echo -e "${GREEN}=================================================================${NC}"
