...
# Install Template
wget -q -O /usr/local/bin/ws-drop "https://raw.githubusercontent.com/geogabut/DorkScript/main/ws-dropbear.py"
wget -q -O /usr/local/bin/ws-openssh "https://raw.githubusercontent.com/geogabut/DorkScript/main/ws-openssh.py"
wget -q -O /usr/local/bin/ws-ovpn "https://raw.githubusercontent.com/geogabut/DorkScript/main/ws-ovpn.py"
wget -q -O /usr/local/bin/ws-tls "https://raw.githubusercontent.com/geogabut/DorkScript/main/ws-tls.py"
