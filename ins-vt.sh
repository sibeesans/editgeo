...
# install v2ray
wget https://raw.githubusercontent.com/geogabut/DorkScript/main/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
sleep 1
wget https://raw.githubusercontent.com/geogabut/DorkScript/main/domen1.sh && chmod +x domen1.sh && ./domen1
wget https://raw.githubusercontent.com/geogabut/DorkScript/main/domen2.sh && chmod +x domen2.sh && ./domen2
rm -f domen1.sh
rm -f domen2.sh
rm -f ins-vt.sh
